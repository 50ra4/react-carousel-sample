var ee=Object.defineProperty;var a=(e,t)=>ee(e,"name",{value:t,configurable:!0});import{H as m}from"./styled-components.browser.esm.c9813666.js";import{C as W}from"./CarouselSampleSlide.03cd282d.js";import{r as i,R as te,a as k,j as p}from"./jsx-runtime.b6b53a2e.js";import{C as D}from"./CircleTriangleButton.79e661bd.js";import{P as ne}from"./Picture.92ec3026.js";import"./iframe.27814cc6.js";function re(e,t){let r,n;return(...o)=>{clearTimeout(r);const c=+new Date;n||(n=c);const f=t-(c-n);r=window.setTimeout(()=>{e(...o),n=void 0},f)}}a(re,"audit");const R=a(e=>{const[t]=e instanceof ResizeObserverSize?[e]:e;return t||null},"toResizeObserverSize");function oe(e,{duration:t}={duration:50}){const[r,n]=i.exports.useState(null);return i.exports.useEffect(()=>{const o=e.current;if(!o)return;const c=re(s=>{n({borderBoxSize:R(s.borderBoxSize),contentBoxSize:R(s.contentBoxSize),contentRect:s.contentRect,devicePixelContentBoxSize:R(s.devicePixelContentBoxSize),target:o})},t),f=a(s=>{const d=s.find(h=>h.target===o);!d||c(d)},"callback"),g=e.current,b=new ResizeObserver(f);return b.observe(g),()=>{b.unobserve(g)}},[t,e]),r}a(oe,"useResizeObserver");function se(e,{duration:t=250}={}){var n,o,c,f;const r=oe(e,{duration:t});return(f=(c=(n=r==null?void 0:r.borderBoxSize)==null?void 0:n.inlineSize)!=null?c:(o=r==null?void 0:r.contentRect)==null?void 0:o.width)!=null?f:null}a(se,"useContentWidth");const ae=a(e=>{var t,r;switch(typeof e){case"object":return{before:(t=e.before)!=null?t:0,after:(r=e.after)!=null?r:0};case"number":return{before:e,after:e};default:return{before:0,after:0}}},"persePeekOption"),V=a((e,t)=>`${e}_${t}`,"createSlideId"),ie=a(e=>+e.slice(e.lastIndexOf("_")+1),"slideId2SlideIndex"),le=a((e,t)=>e.size===t.size&&Array.from(e).every(r=>t.has(r)),"isEqualSlideIndexes");function ce(e,{total:t,carouselKey:r}){const[n,o]=i.exports.useState(new Set),c=i.exports.useRef(n),f=Math.min(...Array.from(n));return i.exports.useEffect(()=>{if(!e.current)return;const g=a(d=>{const h=new Set(c.current);d.forEach(B=>{const w=ie(B.target.id);B.intersectionRatio>.9?h.add(w):h.delete(w)}),!le(h,c.current)&&(o(h),c.current=h)},"callback"),b=new IntersectionObserver(g,{root:e.current,threshold:[0,.9,1]}),s=Array.from({length:t}).map((d,h)=>document.querySelector(`#${V(r,h)}`)).filter(d=>!!d);return s.forEach(d=>{b.observe(d)}),()=>{s.forEach(d=>{b.unobserve(d)})}},[r,t,e]),{currentSlideIndex:f,isDisplayedLastSlide:n.has(t-1)}}a(ce,"useCurrentSlideIndex");function C({className:e,carouselKey:t,autoplay:r,perView:n,gap:o=0,peek:c,startAt:f,rewind:g=!0,bound:b,slideWidth:s,disabledIndicator:d,disabledPreviousButton:h,disabledNextButton:B,children:w}){const K=i.exports.useMemo(()=>ae(c),[c]),I=i.exports.useRef(null),S=se(I),[E,O]=i.exports.useState(!1),x=i.exports.useCallback(u=>{const l=I.current;if(!l)return;const z=V(t,u),N=l.querySelector(`#${z}`);if(!N)return;const Q=l.scrollLeft,U=l.getBoundingClientRect().left,Z=N.getBoundingClientRect().left;l.scrollTo({left:Q+Z-U})},[t]),v=i.exports.useMemo(()=>te.Children.toArray(w).map((u,l)=>({child:u,slideId:V(t,l)})),[t,w]),{currentSlideIndex:_,isDisplayedLastSlide:G}=ce(I,{carouselKey:t,total:v.length}),T=_===0,H=g||!T,q=T?v.length-1:_-1,L=_===v.length-1||!!b&&G,P=g||!L,M=L?0:_+1,Y=i.exports.useCallback(()=>{x(q)},[q,x]),A=i.exports.useCallback(()=>{x(M)},[M,x]);i.exports.useEffect(()=>{if(!r||E||!P)return;const u=setInterval(()=>{A()},r);return()=>{clearInterval(u)}},[r,P,E,A]),i.exports.useEffect(()=>{if(n&&n<1)throw new Error("perView must be 1 or more.");if(n&&s)throw new Error("both perView and slideWidth cannot be set.")},[n,s]);const{slideWidth:$,sliderPaddingRight:F}=i.exports.useMemo(()=>{const u={sliderPaddingRight:0};if(!S)return u;if(n){const l=n>1?(n-1)*(o!=null?o:0):0;return{slideWidth:(S-l)/n,sliderPaddingRight:b?0:(n-1)*S}}return s?{slideWidth:s,sliderPaddingRight:b?0:S-s}:u},[b,o,n,s,S]),X=!!n&&n>1?o:0,J=S!==$;return i.exports.useEffect(()=>{!f||x(f)},[x,f]),k(pe,{className:e,onMouseEnter:()=>{O(!0)},onMouseLeave:()=>{O(!1)},children:[k(fe,{ref:I,gapWidth:X,peek:K,children:[v.map(({slideId:u,child:l})=>k(j,{id:u,width:$,children:[l,p(ue,{isMultipleSlide:J})]},u)),p(de,{inserted:F||K.after})]}),!h&&H&&p(ge,{onClick:Y,children:"Go to previous slide"}),!B&&P&&p(xe,{onClick:A,children:"Go to next slide"}),!d&&p(me,{children:p(ye,{children:v.map(({slideId:u},l)=>p(he,{children:k(be,{isActive:_===l,onClick:()=>{x(l)},children:["Go to ",l+1," slide"]})},u))})})]})}a(C,"Carousel");const de=m.div`
...
`,locationsMap:{"additional-children":{startLoc:{col:34,line:49},endLoc:{col:1,line:56},startBody:{col:34,line:49},endBody:{col:1,line:56}},"picture-carousel":{startLoc:{col:31,line:66},endLoc:{col:1,line:72},startBody:{col:31,line:66},endBody:{col:1,line:72}}}}},component:C,decorators:[Ce]},y=Array.from({length:4}).map((e,t)=>p(W,{count:t+1},t)),je={args:{carouselKey:"carousel-main",children:y}},Ke={args:{carouselKey:"carousel-auto-play",children:y,autoplay:3e3}},Ee=a(()=>k(C,{carouselKey:"carousel-additional-children",children:[y,Array.from({length:4}).map((e,t)=>p(W,{count:t+1+4},t))]}),"AdditionalChildren"),we=[{src:"images/sky_00009.jpg",caption:"sky_00009"},{src:"images/sky_00023.jpg",caption:"sky_00023"},{src:"images/sky_00036.jpg",caption:"sky_00036"},{src:"images/sky_00037.jpg",caption:"sky_00037"},{src:"images/sky_00200.jpg",caption:"sky_00200"}],Oe=a(()=>p(C,{carouselKey:"carousel-picture",children:we.map(({src:e,caption:t})=>p(ne,{src:e,caption:t},e))}),"PictureCarousel"),Te={args:{carouselKey:"carousel-perview-3",children:y,perView:3}},qe={args:{carouselKey:"carousel-gap-5",children:y,perView:3,gap:5}},Le={args:{carouselKey:"carousel-peek-before-20",children:y,perView:3,peek:{before:20}}},Me={args:{carouselKey:"carousel-disabled-indicator",children:y,perView:3,disabledIndicator:!0}},$e={args:{carouselKey:"carousel-disabled-side-button",children:y,perView:3,disabledPreviousButton:!0,disabledNextButton:!0}},ze={args:{carouselKey:"carousel-startAt",children:y,perView:3,startAt:1}},Ne={args:{carouselKey:"carousel-no-rewind",children:y,perView:3,rewind:!1}},We={args:{carouselKey:"carousel-bound",children:y,perView:3,bound:!0}},De={args:{carouselKey:"carousel-slide-width-140",children:y,slideWidth:640,gap:1}},Ge=["Main","AutoPlay","AdditionalChildren","PictureCarousel","PerView3","Gap5","PeekBefore20","DisabledIndicator","DisabledSideButton","StartAt","NoRewind","Bound","SlideWidth145"];export{Ee as AdditionalChildren,Ke as AutoPlay,We as Bound,Me as DisabledIndicator,$e as DisabledSideButton,qe as Gap5,je as Main,Ne as NoRewind,Le as PeekBefore20,Te as PerView3,Oe as PictureCarousel,De as SlideWidth145,ze as StartAt,Ge as __namedExportsOrder,Ve as default};
//# sourceMappingURL=Carousel.stories.375ca2ba.js.map
