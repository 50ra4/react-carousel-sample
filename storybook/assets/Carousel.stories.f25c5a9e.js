var U=Object.defineProperty;var a=(e,n)=>U(e,"name",{value:n,configurable:!0});import{H as d}from"./styled-components.browser.esm.179ab00f.js";import{C as M}from"./CarouselSampleSlide.204c29d5.js";import{r as t,R as Z,a as w,j as l}from"./jsx-runtime.fa9b0575.js";import{C as q}from"./CircleTriangleButton.e2a2aead.js";import{P as ee}from"./Picture.43f6a240.js";import"./iframe.6dcdbe1c.js";function ne(e){const[n,o]=t.exports.useState(null),r=t.exports.useRef(0),f=t.exports.useCallback(i=>{i!==r.current&&(console.log(`current width: ${i}px`),o(i),r.current=i)},[]);return t.exports.useEffect(()=>{if(!e.current)return;const i=a(g=>{g.forEach(x=>{f(x.contentRect.width)})},"callback"),y=e.current,h=new ResizeObserver(i);return h.observe(y),()=>{h.unobserve(y)}},[e,f]),n}a(ne,"useContentWidth");const te=a(e=>{var n,o;return typeof e=="object"?{before:(n=e.before)!=null?n:0,after:(o=e.after)!=null?o:0}:typeof e=="number"?{before:e,after:e}:{before:0,after:0}},"persePeek"),re=a(e=>{var n,o;return typeof e=="object"?{previous:(n=e.previous)!=null?n:!1,next:(o=e.next)!=null?o:!1}:typeof e=="boolean"?{previous:e,next:e}:{previous:!1,next:!1}},"perseSideNavigationOption"),K=a((e,n)=>`${e}_${n}`,"createSlideId"),oe=a(e=>+e.slice(e.lastIndexOf("_")+1),"slideId2SlideIndex"),se=a((e,n)=>e.size===n.size&&Array.from(e).every(o=>n.has(o)),"isEqualSlideIndexes");function ae(e,{total:n,carouselKey:o}){const[r,f]=t.exports.useState(new Set),i=t.exports.useRef(r),y=Math.min(...Array.from(r));return t.exports.useEffect(()=>{if(!e.current)return;const h=a(u=>{const m=new Set(i.current);u.forEach(C=>{const v=oe(C.target.id);C.intersectionRatio>.9?m.add(v):m.delete(v)}),!se(m,i.current)&&(f(m),i.current=m)},"callback"),g=new IntersectionObserver(h,{root:e.current,threshold:[0,.9,1]}),x=Array.from({length:n}).map((u,m)=>document.querySelector(`#${K(o,m)}`)).filter(u=>!!u);return x.forEach(u=>{g.observe(u)}),()=>{x.forEach(u=>{g.unobserve(u)})}},[o,n,e]),{currentSlideIndex:y,isDisplayedLastSlide:r.has(n-1)}}a(ae,"useCurrentSlideIndex");function S({className:e,carouselKey:n,autoplay:o,perView:r,gap:f=0,peek:i,startAt:y,rewind:h=!0,bound:g,disabledIndicator:x,disabledSideNavigation:u,children:m}){const C=t.exports.useMemo(()=>te(i),[i]),v=t.exports.useMemo(()=>re(u),[u]),I=t.exports.useRef(null),A=ne(I),[{slideWidth:P,sliderPaddingRight:W,gapWidth:D},G]=t.exports.useState({slideWidth:null,sliderPaddingRight:0,gapWidth:0}),[B,E]=t.exports.useState(!1),b=t.exports.useCallback(c=>{const s=I.current;if(!s)return;const H=K(n,c),L=s.querySelector(`#${H}`);if(!L)return;const X=s.scrollLeft,J=s.getBoundingClientRect().left,Q=L.getBoundingClientRect().left;s.scrollTo({left:X+Q-J})},[n]),_=t.exports.useMemo(()=>Z.Children.toArray(m).map((c,s)=>({child:c,slideId:K(n,s)})),[n,m]),{currentSlideIndex:k,isDisplayedLastSlide:Y}=ae(I,{carouselKey:n,total:_.length}),O=k===0,z=h||!O,$=O?_.length-1:k-1,N=k===_.length-1||!!g&&Y,j=h||!N,T=N?0:k+1,F=t.exports.useCallback(()=>{b($)},[$,b]),V=t.exports.useCallback(()=>{b(T)},[T,b]);return t.exports.useEffect(()=>{if(!o||B||!j)return;const c=setInterval(()=>{V()},o);return()=>{clearInterval(c)}},[o,j,B,V]),t.exports.useEffect(()=>{if(!r)return;if(r<1)throw new Error("perView must be 1 or more.");if(!A)return;const c=r>1?(r-1)*(f!=null?f:0):0,s=(A-c)/r;G({slideWidth:s,sliderPaddingRight:g?0:(r-1)*A,gapWidth:r>1?f:0})},[g,f,r,A]),t.exports.useEffect(()=>{!y||b(y)},[b,y]),w(ce,{className:e,onMouseEnter:()=>{E(!0)},onMouseLeave:()=>{E(!1)},children:[w(de,{ref:I,gapWidth:D,peek:C,children:[_.map(({slideId:c,child:s})=>w(R,{id:c,width:P!=null?P:void 0,children:[s,l(le,{multipleSlide:!!r&&r>1})]},c)),l(ie,{inserted:W||C.after})]}),!v.previous&&z&&l(ye,{onClick:F,children:"Go to previous slide"}),!v.next&&j&&l(ge,{onClick:V,children:"Go to next slide"}),!x&&l(ue,{children:l(pe,{children:_.map(({slideId:c},s)=>l(fe,{children:w(me,{isActive:k===s,onClick:()=>{b(s)},children:["Go to ",s+1," slide"]})},c))})})]})}a(S,"Carousel");const ie=d.div`
