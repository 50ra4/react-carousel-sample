var w=Object.defineProperty;var d=(t,e)=>w(t,"name",{value:e,configurable:!0});import{r as p,a as h,j as a}from"./jsx-runtime.bcfebb72.js";import{H as i}from"./styled-components.browser.esm.9c3e7ae4.js";import"./iframe.09e6959a.js";const m=d((t,e)=>`${t}_${e}`,"createSlideId"),S=d((t,e)=>e===t.length-1?t[0]:t[e+1],"getNextCarouselItem");function g({className:t,carouselKey:e,items:c,options:{autoplay:x}={}}){const f=p.exports.useRef(null),u=p.exports.useCallback(o=>{var n,s;const r=(s=(n=f.current)==null?void 0:n.querySelector(`#${o}`))!=null?s:void 0;!r||r.scrollIntoView()},[]),l=p.exports.useMemo(()=>c.map(o=>({...o,slideId:m(e,o.key)})),[e,c]),[b,k]=p.exports.useState(l[0].slideId);p.exports.useEffect(()=>{if(!f.current)return;const o=d(s=>{s.forEach(C=>{!C.isIntersecting||k(C.target.id)})},"callback"),r=new IntersectionObserver(o,{root:f.current,threshold:1}),n=l.map(({slideId:s})=>document.querySelector(`#${s}`)).filter(s=>!!s);return n.forEach(s=>{r.observe(s)}),()=>{n.forEach(s=>{r.unobserve(s)})}},[e,l]);const[y,v]=p.exports.useState(!1);return p.exports.useEffect(()=>{if(!x||y)return;const o=l.findIndex(n=>n.slideId===b);if(o<0)return;const r=setInterval(()=>{const n=m(e,S(l,o).key);u(n)},x);return()=>{clearInterval(r)}},[x,e,b,y,u,l]),h(N,{ref:f,className:t,onMouseEnter:()=>{v(!0)},onMouseLeave:()=>{v(!1)},children:[a(O,{children:l.map(({slideId:o},r)=>h(E,{id:o,children:[a(A,{}),a(j,{onClick:()=>{const n=m(e,r===0?c[c.length-1].key:c[r-1].key);u(n)},children:"Go to previous slide"}),a(B,{onClick:()=>{const n=m(e,S(l,r).key);u(n)},children:"Go to next slide"})]},o))}),a(R,{children:a($,{className:t,children:l.map(({slideId:o,caption:r})=>a(q,{children:h(T,{isActive:b===o,onClick:()=>{u(o)},children:["Go to ",r]})},o))})})]})}d(g,"Carousel");const A=i.div`
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
...
//# sourceMappingURL=Carousel.stories.e224b177.js.map
