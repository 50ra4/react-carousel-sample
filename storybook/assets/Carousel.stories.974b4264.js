var ee=Object.defineProperty;var i=(e,t)=>ee(e,"name",{value:t,configurable:!0});import{H as m}from"./styled-components.browser.esm.80a5d116.js";import{C as W}from"./CarouselSampleSlide.2f926d2c.js";import{r as o,R as te,a as k,j as p}from"./jsx-runtime.4b1fe029.js";import{C as D}from"./CircleTriangleButton.9c2c6a6e.js";import{P as ne}from"./Picture.45313b01.js";import"./iframe.e1a01d07.js";function re(e,t){let r,n;return(...s)=>{clearTimeout(r);const c=+new Date;n||(n=c);const f=t-(c-n);r=window.setTimeout(()=>{e(...s),n=void 0},f)}}i(re,"audit");const R=i(e=>{const[t]=e instanceof ResizeObserverSize?[e]:e;return t||null},"toResizeObserverSize");function oe(e,{duration:t}={duration:50}){const[r,n]=o.exports.useState(null);return o.exports.useEffect(()=>{const s=e.current;if(!s)return;const c=re(a=>{n({borderBoxSize:R(a.borderBoxSize),contentBoxSize:R(a.contentBoxSize),contentRect:a.contentRect,devicePixelContentBoxSize:R(a.devicePixelContentBoxSize),target:s})},t),f=i(a=>{const d=a.find(h=>h.target===s);!d||c(d)},"callback"),g=e.current,b=new ResizeObserver(f);return b.observe(g),()=>{b.unobserve(g)}},[t,e]),r}i(oe,"useResizeObserver");function se(e,{duration:t=250}={}){const r=oe(e,{duration:t});return o.exports.useMemo(()=>{var n,s,c,f;return(f=(c=(n=r==null?void 0:r.borderBoxSize)==null?void 0:n.inlineSize)!=null?c:(s=r==null?void 0:r.contentRect)==null?void 0:s.width)!=null?f:null},[r])}i(se,"useContentWidth");const ae=i(e=>{var t,r;switch(typeof e){case"object":return{before:(t=e.before)!=null?t:0,after:(r=e.after)!=null?r:0};case"number":return{before:e,after:e};default:return{before:0,after:0}}},"persePeekOption"),V=i((e,t)=>`${e}_${t}`,"createSlideId"),ie=i(e=>+e.slice(e.lastIndexOf("_")+1),"slideId2SlideIndex"),le=i((e,t)=>e.size===t.size&&Array.from(e).every(r=>t.has(r)),"isEqualSlideIndexes");function ce(e,{total:t,carouselKey:r}){const[n,s]=o.exports.useState(new Set),c=o.exports.useRef(n),f=Math.min(...Array.from(n));return o.exports.useEffect(()=>{if(!e.current)return;const g=i(d=>{const h=new Set(c.current);d.forEach(B=>{const w=ie(B.target.id);B.intersectionRatio>.9?h.add(w):h.delete(w)}),!le(h,c.current)&&(s(h),c.current=h)},"callback"),b=new IntersectionObserver(g,{root:e.current,threshold:[0,.9,1]}),a=Array.from({length:t}).map((d,h)=>document.querySelector(`#${V(r,h)}`)).filter(d=>!!d);return a.forEach(d=>{b.observe(d)}),()=>{a.forEach(d=>{b.unobserve(d)})}},[r,t,e]),{currentSlideIndex:f,isDisplayedLastSlide:n.has(t-1)}}i(ce,"useCurrentSlideIndex");function C({className:e,carouselKey:t,autoplay:r,perView:n,gap:s=0,peek:c,startAt:f,rewind:g=!0,bound:b,slideWidth:a,disabledIndicator:d,disabledPreviousButton:h,disabledNextButton:B,children:w}){const K=o.exports.useMemo(()=>ae(c),[c]),I=o.exports.useRef(null),S=se(I),[E,O]=o.exports.useState(!1),x=o.exports.useCallback(u=>{const l=I.current;if(!l)return;const z=V(t,u),N=l.querySelector(`#${z}`);if(!N)return;const Q=l.scrollLeft,U=l.getBoundingClientRect().left,Z=N.getBoundingClientRect().left;l.scrollTo({left:Q+Z-U})},[t]),v=o.exports.useMemo(()=>te.Children.toArray(w).map((u,l)=>({child:u,slideId:V(t,l)})),[t,w]),{currentSlideIndex:_,isDisplayedLastSlide:G}=ce(I,{carouselKey:t,total:v.length}),T=_===0,H=g||!T,M=T?v.length-1:_-1,q=_===v.length-1||!!b&&G,P=g||!q,L=q?0:_+1,Y=o.exports.useCallback(()=>{x(M)},[M,x]),A=o.exports.useCallback(()=>{x(L)},[L,x]);o.exports.useEffect(()=>{if(!r||E||!P)return;const u=setInterval(()=>{A()},r);return()=>{clearInterval(u)}},[r,P,E,A]),o.exports.useEffect(()=>{if(n&&n<1)throw new Error("perView must be 1 or more.");if(n&&a)throw new Error("both perView and slideWidth cannot be set.")},[n,a]);const{slideWidth:$,sliderPaddingRight:F}=o.exports.useMemo(()=>{const u={sliderPaddingRight:0};if(!S)return u;if(n){const l=n>1?(n-1)*(s!=null?s:0):0;return{slideWidth:(S-l)/n,sliderPaddingRight:b?0:(n-1)*S}}return a?{slideWidth:a,sliderPaddingRight:b?0:S-a}:u},[b,s,n,a,S]),X=!!n&&n>1?s:0,J=S!==$;return o.exports.useEffect(()=>{!f||x(f)},[x,f]),k(pe,{className:e,onMouseEnter:()=>{O(!0)},onMouseLeave:()=>{O(!1)},children:[k(fe,{ref:I,gapWidth:X,peek:K,children:[v.map(({slideId:u,child:l})=>k(j,{id:u,width:$,children:[l,p(ue,{isMultipleSlide:J})]},u)),p(de,{inserted:F||K.after})]}),!h&&H&&p(ge,{onClick:Y,children:"Go to previous slide"}),!B&&P&&p(xe,{onClick:A,children:"Go to next slide"}),!d&&p(me,{children:p(ye,{children:v.map(({slideId:u},l)=>p(he,{children:k(be,{isActive:_===l,onClick:()=>{x(l)},children:["Go to ",l+1," slide"]})},u))})})]})}i(C,"Carousel");const de=m.div`
...
`;try{C.displayName="Carousel",C.__docgenInfo={description:"",displayName:"Carousel",props:{autoplay:{defaultValue:null,description:"autoplay milliseconds. default: no autoplay",name:"autoplay",required:!1,type:{name:"number"}},perView:{defaultValue:null,description:"a number of slides visible on the slider. default: 1",name:"perView",required:!1,type:{name:"number"}},gap:{defaultValue:{value:"0"},description:"add margin between slides. But 0 when perView is 1. default: 0",name:"gap",required:!1,type:{name:"number"}},peek:{defaultValue:null,description:"The value of the future slider which have to be visible in the current view. default: 0",name:"peek",required:!1,type:{name:"PeekOption"}},startAt:{defaultValue:null,description:"Start at specific slide number. default: 0",name:"startAt",required:!1,type:{name:"number"}},rewind:{defaultValue:{value:"true"},description:"allow looping. default: true",name:"rewind",required:!1,type:{name:"boolean"}},bound:{defaultValue:null,description:"stop running perView number of slides from the end",name:"bound",required:!1,type:{name:"boolean"}},slideWidth:{defaultValue:null,description:"sets the width of the slide. However, it cannot be used together with the preview.",name:"slideWidth",required:!1,type:{name:"number"}},disabledIndicator:{defaultValue:null,description:"hide Indicator. default: false",name:"disabledIndicator",required:!1,type:{name:"boolean"}},disabledPreviousButton:{defaultValue:null,description:"hide PreviousButton. default: false",name:"disabledPreviousButton",required:!1,type:{name:"boolean"}},disabledNextButton:{defaultValue:null,description:"hide NextButton. default: false",name:"disabledNextButton",required:!1,type:{name:"boolean"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},carouselKey:{defaultValue:null,description:"",name:"carouselKey",required:!0,type:{name:"string"}}}},typeof STORYBOOK_REACT_CLASSES<"u"&&(STORYBOOK_REACT_CLASSES["src/presentation/components/Carousel/Carousel.tsx#Carousel"]={docgenInfo:C.__docgenInfo,name:"Carousel",path:"src/presentation/components/Carousel/Carousel.tsx#Carousel"})}catch{}const Se=m.div`
  max-width: 600px;
  height: 450px;
`,Ce=i((e,t)=>p(Se,{children:p(e,{...t})}),"withStyleWrapper"),Ve={parameters:{storySource:{source:`import type {
  ComponentStoryObj,
  ComponentMeta,
  DecoratorFn,
