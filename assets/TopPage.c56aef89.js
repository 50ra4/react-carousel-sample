import{s as i,j as y,a as t,r as o,R as U}from"./index.b59762cd.js";function F({className:e,onClick:r,children:n}){return y(Z,{className:e,onClick:r,children:[t(ee,{}),n]})}const Z=i.button`
  cursor: pointer;
  width: 32px;
  height: 32px;
  border-radius: 50%;
