import{s as i,j as x,a as t,r as p,R as ee}from"./index.37afef24.js";import{u as te,P as re}from"./PageTemplate.f58a82c8.js";function F({className:e,onClick:r,children:s}){return x(ie,{className:e,onClick:r,children:[t(ne,{}),s]})}const ie=i.button`
  cursor: pointer;
  width: 32px;
  height: 32px;
  border-radius: 50%;
