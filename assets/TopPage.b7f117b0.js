import{s as i,j as y,a as t,r as n,R as U}from"./index.788029ae.js";function F({className:e,onClick:r,children:o}){return y(Z,{className:e,onClick:r,children:[t(ee,{}),o]})}const Z=i.button`
  cursor: pointer;
  width: 32px;
  height: 32px;
  border-radius: 50%;
