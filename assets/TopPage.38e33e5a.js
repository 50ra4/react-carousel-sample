import{s as i,j as m,a as t,r as d,R as U}from"./index.d6788143.js";import{u as Z,P as ee}from"./PageTemplate.8009fae8.js";function N({className:e,onClick:r,children:l}){return m(te,{className:e,onClick:r,children:[t(re,{}),l]})}const te=i.button`
  cursor: pointer;
  width: 32px;
  height: 32px;
  border-radius: 50%;
