import{s as i,j as x,a as t,r as p,R as ee}from"./index.3be6d876.js";import{u as te}from"./useContentWidth.fd53185b.js";import{P as re}from"./PageTemplate.b1f5d12a.js";function F({className:e,onClick:r,children:s}){return x(ie,{className:e,onClick:r,children:[t(ne,{}),s]})}const ie=i.button`
  cursor: pointer;
  width: 32px;
  height: 32px;
  border-radius: 50%;
