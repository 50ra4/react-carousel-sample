import{s as i,j as m,a as t,r as s,R as Z}from"./index.83b5897a.js";function M({className:e,onClick:r,children:n}){return m(ee,{className:e,onClick:r,children:[t(te,{}),n]})}const ee=i.button`
  cursor: pointer;
  width: 32px;
  height: 32px;
  border-radius: 50%;
